---
title: Quickstart
description: Run aCMF locally with Docker, migrations, and stub, Anthropic, or OpenAI-compatible providers.
---
...
When you switch from `stub` to real providers, these are the recommended models:
...
If you want a Claude-first setup, use `anthropic` for the three chat roles and keep embeddings on `openai_compatible`.
